export default () => ({
  ...
  KYUPAD_LINK_TWITTER: process.env.KYUPAD_LINK_TWITTER,
  KYUPAD_LINK_DISCORD: process.env.KYUPAD_LINK_DISCORD,
  KYUPAD_LINK_PRIVACY_POLICY_LINK: process.env.KYUPAD_LINK_PRIVACY_POLICY_LINK,
  API_KEY: process.env.API_KEY,
  KYUPAD_LINK_TERMS_CONDITIONS_LINK:
    process.env.KYUPAD_LINK_TERMS_CONDITIONS_LINK,
});
